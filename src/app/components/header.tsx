...
const Header = () => {
  return (
    <div className="px-8 lg:px-10 pt-4">
      <div className="bg-[#000] font-judson w-[100%] m-auto mb-10 p-[16px] flex justify-between items-center rounded-[16px] backdrop-blur-[10px] ">
        ...
        <form className="relative">
          ...
          <input
            ...
            className="rounded-[6px] outline-none border border-[#b3b3b3] md:w-[358px] h-[44px] text-[#b3b3b3] bg-[#000] flex py-[8px] px-[12px] items-center justify-center gap-[12px] text-[14px] leading-[20.3px] pl-6 "
          />
          <button
            type="submit"
            aria-label="Submit-search"
            className="absolute left-2 top-[39%]"
          >
            <svg
              fill="none"
              viewBox="0 0 13 14"
